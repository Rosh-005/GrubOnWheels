                            ...
                            <div class="col-md-12 grid-margin">
                                <div class="row" >
                                    <div class="col-md-12 grid-margin stretch-card" >
                                        <div class="card" >
                                            <div class="card-body">
                                                <center><p class="card-title mb-0" style="font-size: 30px"><%=session.getAttribute("fname").toString()%> Delivery Feedbacks</p></center>
                                                <br>
                                                <br>
                                                    ...
                                                    <table class="table table-striped table-borderless">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                try {
                                                                    ResultSet rs1 = st.executeQuery("Select distinct oid, uname from useroders where daid='"+did+"' order by id DESC");
                                                                    while(rs1.next()){
                                                                    String OID=rs1.getString("oid");
                                                                    
                                                                    ResultSet rs = st1.executeQuery("Select * from del_feedback df where order_id='"+OID+"' and DATE(STR_TO_DATE(df.`time`,'%Y/%m/%d %H:%i:%s'))=CURDATE() order by id DESC");
                                                                    while (rs.next()) {
                                                            %>
                                                            <tr>
