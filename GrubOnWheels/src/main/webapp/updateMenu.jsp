                                    ...
                                    <div class="col-md-12 grid-margin stretch-card" >
                                        <div class="card" >
                                            <div class="card-body" style="background-color: beige">
                                                <center><p class="card-title mb-0" style="font-size: 30px"><%=session.getAttribute("restname").toString()%> Menu List</p></center>
                                                <br>
                                                <br>
                                                    ...
                                                    <table class="table table-striped table-borderless">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                try {
                                                                    ResultSet rs = st.executeQuery("Select * from restaurant_menu where restid='"+restid+"'");
                                                                    while (rs.next()) {
                                                        ...
                                                        <form action="UpdateMenu" method="post">
                                                            <td ><input style="border-color:orange;width: 80px" type="text" name="price" value="<%=rs.getString("price")%>"></td>
                                                                ...
                                                                <td><a href="DeleteMenu?id=<%=rs.getString("id")%>" class="btn btn-group-lg btn-danger">Delete</a></td>
                                                                <%                                        }
                                                                        rs.close();
                                                                        con.close();
                                                                    } catch (Exception ex) {
