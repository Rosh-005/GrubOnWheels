...
<head>
  ...
  <style type="text/css">
body {
	background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(Resources/images/admin.jpg);
...
<a href="index.jsp" id="home-icon" class="home-icon" style="position: absolute; top: 0px; left: 0px;">
    ...
    <h1 style="font-size: 60px;margin-top: 60px">Grub On Wheels🚚</h1>
