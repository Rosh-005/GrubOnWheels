                                    ...
                                    <div class="col-md-12 grid-margin stretch-card" >
                                        <div class="card" >
                                            <div class="card-body" style="background-color: beige">
                                                <center><p class="card-title mb-0" style="font-size: 30px"><%=session.getAttribute("restname").toString()%> Feedbacks</p></center>
                                                <br>
                                                <br>
                                                    ...
                                                    <table class="table table-striped table-borderless">
                                                        ...
                                                        <tbody>
                                                            <%
                                                                ...
                                                                try {
                                                                    ResultSet rs = st.executeQuery("Select * from del_feedback where resid='"+restid+"' order by id DESC");
                                                                    while (rs.next()) {
                                                            %>
                                                            <tr>
