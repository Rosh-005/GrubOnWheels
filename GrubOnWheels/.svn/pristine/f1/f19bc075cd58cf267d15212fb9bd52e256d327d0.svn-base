...
<html lang="en">
    ...
    <body>
        ...
        <% String keyword = request.getParameter("cityName"); 
                ...
                <div class="container hotel-list">
                    ...
                    <div class="row">
                        <%
                            ...
                            try {
                                ResultSet resultSet = stmt.executeQuery("Select * from restaurants where statuss='Active' and city='" + keyword + "'");
                                while (resultSet.next()) {

                        %>
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <a href="restaurantMenu.jsp?id=<%=resultSet.getString("id")%>&city=<%=resultSet.getString("city")%>&name=<%=resultSet.getString("restname")%>">
                                    <img class="hotel-img"src="restaurantImg.jsp?imgid=<%=resultSet.getString("id")%>" alt="<%=resultSet.getString("restname")%>" style="width:250px;height: 200px">
                                </a>
                                <div class="caption">
                                    <p class="hotel-name"><%=resultSet.getString("restname")%></p>
